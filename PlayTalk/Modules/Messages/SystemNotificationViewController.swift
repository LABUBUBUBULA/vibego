...
class SystemNotificationViewController: UIViewController {
    ...
    private let notifications: [(icon: String, title: String, content: String, time: String)] = [
        ("bell.badge.fill", "Welcome to VibeGo!", "Thank you for joining our community. Start exploring voice rooms and make new friends!", "2h ago"),
        ...
        ("doc.text.fill", "Community Guidelines", "Please review our updated community guidelines to keep VibeGo safe and fun.", "2d ago"),
